         ...
         onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            ...
            <div className={`video-overlay-container ${isHeroHovered? 'active': ''}`}>
                <div className="video-controls-container">
                    <button onClick={() => setCurrentVideoState(prev => (prev-1<0)? 2: prev-1)} className="video-control">
                    ...
                    <button onClick={() => setCurrentVideoState(prev => (prev+1)%3)} className="video-control">
